/* main.js - lógica do site, comentada em português
   - Organizei as partes: entrada, áudio ambiente, cursor estrela, confetti,
...
/* LINKS das músicas do Spotify - troque os IDs aqui, se quiser outras tracks.
   Ex.: https://open.spotify.com/embed/track/THE_TRACK_ID
   -> mantenha o formato 'https://open.spotify.com/embed/track/SEU_ID'
*/
const spotifyEmbeds = [
  'https://open.spotify.com/embed/track/3WGAaYgRzYbJtR1UwxL1tr', // RM - Right Place, Wrong Person
  'https://open.spotify.com/embed/track/4TvKz6cgxZSMuwiHglQ8cv', // beabadoobee - Glue Song (exemplo)
  'https://open.spotify.com/embed/track/3U21A07gAloCc4P7J8rxcn', // Paramore (exemplo)
  'https://open.spotify.com/embed/track/4kflIGfjdZJW4ot2ioixTB'  // NewJeans (exemplo)
];
...
enterBtn.addEventListener('click', async () => {
  ...
  spIframes.forEach((ifrm, i) => {
    ifrm.src = spotifyEmbeds[i] + '?utm_source=generator';
  });
...
/* Explicação:
   ...
   - O SVG usado para a imagem do puzzle está embutido em `svgNight`.
   - Para trocar a imagem do puzzle: altere o conteúdo SVG em `svgNight`
     ou aponte `imgUrl` para uma imagem externa.
*/
const puzzleEl = document.getElementById('puzzleGrid');
const SIZE = 3;
let board = [];

// SVG noturno (embutido). Troque este SVG se quiser outra arte.
// Se preferir usar uma imagem externa, substitua imgUrl por:
// const imgUrl = 'assets/minha-imagem.jpg';
const svgNight = encodeURIComponent(`<?xml version='1.0' encoding='UTF-8'?>
<svg xmlns='https://art.pixilart.com/thumb/sr2e8487a2b12aws3.png' viewBox='0 0 300 300'>
  <rect width='100%' height='100%' fill='%23080b1a'/>
  <g opacity='0.98'>
    <ellipse cx='150' cy='200' rx='110' ry='50' fill='%230b1b2a'/>
    <path d='M60 160c12-18 36-28 62-28s50 10 62 28' fill='%23b8d8ff' opacity='0.06'/>
    <g transform='translate(36,40)'>
      <rect x='30' y='90' width='140' height='80' rx='14' fill='%23cbb7ff'/>
      <circle cx='60' cy='120' r='8' fill='%23ffd4a3'/>
      <circle cx='120' cy='120' r='6' fill='%23ffd4a3'/>
    </g>
  </g>
  <text x='150' y='40' text-anchor='middle' font-size='20' fill='%23dfe9ff' font-family='Poppins,sans-serif'>Cardigan & Llaveros</text>
</svg>`);
const imgUrl = `data:image/svg+xml;utf8,${svgNight}`;
